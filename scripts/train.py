...
import torch
import yaml
# from src.training.training_loop.Trainer import data_read

train_dataset = AllQM9Dataset(file_path=f"../data/train_data.pickle")
train_loader = DataLoader(train_dataset, batch_size=4, shuffle=True)

valid_dataset = AllQM9Dataset(file_path=f"../data/valid_data.pickle")
