...
from src.models.utils import center_zero
...
class Evaluator:
    ...
    def eval_plot(
            self, x: np.ndarray, h: np.ndarray, ptr: np.ndarray, max_num_plots: int = 15, save_path: str = None
    ):
        eval_plot(x, h, ptr, max_num_plots, save_path=save_path)
