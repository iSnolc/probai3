...
DATASET_INFO = {
    ...
    "max_n_nodes": 19,  # 节点数最多的分子，拥有19个原子节点
    "colors_dic": ["#FFFFFF99", "C7", "C0", "C3", "C1"],  # 规定颜色
    "radius_dic": [0.46, 0.77, 0.77, 0.77, 0.77],  # 规定半径大小
    "with_h": True,  # 目前还不知道
    "alpha_mean": 75.3682,  # 平均值
    "alpha_std": 8.6825,  # 标准值
}


class AllQM9Dataset(Dataset): # 实例化，继承
    """
    A dataset class for handling the All_MiniQM9 dataset. This class supports loading
    ...
    def __init__(
            ...
            file_path="../../data/final_data/final_train_data.pickle",
    ):
    ...
    def __getitem__(self, idx: int):
        ...
        sample = Data(
            h=torch.Tensor(atom_type_sample),
